...
/// <summary>
/// A way to create and manage views for buffer. Creating the Buffer must be
/// handled elsewhere. MUST BE CREATED BEFORE THE BUFFER IS ALLOCATED. IT WILL
/// SUBSCRIBE TO THE ALLOCATION EVENT! Useful for example, when you need to
/// create a srv or uav for a vertexBuffer where the vertexBuffer is created and
/// handled by a different part of the code. This only creates the views for it,
/// for (among many things) compute shaders.
///
/// </summary>
