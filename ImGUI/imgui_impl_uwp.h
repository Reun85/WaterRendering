...
// This needs to be used along with a Renderer (e.g. DirectX11, DirectX12,
// SDL2..)
...
// Configs:
//  #define IMGUI_DISABLE_UWP_DEFAULT_CLIPBOARD_FUNCTIONS     // Don't implement
//  default WinRT clipboard handler. #define IMGUI_IMPL_UWP_DISABLE_GAMEPAD //
//  Don't implement default XInput gamepad handler.
...
IMGUI_IMPL_API bool
ImGui_ImplUwp_Init(void *core_window); // ABI::Windows::UI::Core::ICoreWindow*
