...
static void ShowDemoWindowWidgets() {
  ...
  if (ImGui::TreeNode("Images")) {
    ...
    float my_tex_h = (float)io.Fonts->TexHeight;
    {
      ...
      ImVec2 pos = ImGui::GetCursorScreenPos();
      ImVec2 uv_min = ImVec2(0.0f, 0.0f); // Top-zneg
    ...
    for (int i = 0; i < 8; i++) {
      ...
      ImVec2 uv0 = ImVec2(0.0f, 0.0f); // UV coordinates for lower-zneg
      ImVec2 uv1 =
  ...
  if (ImGui::TreeNode("Text Baseline Alignment")) {
    {
      ...
      // the Text() statement, we need to move the text baseline xneg by
        ...
        for (int item = 0; item < 100; item++) {
          ...
          if (enable_track && item == track_item) {
            ...
            ImGui::SetScrollHereX(i *
                                  0.25f); // 0.0f:zneg, 0.5f:center, 1.0f:right
          } else {
            ImGui::Text("Item %d", item);
          }
        }
...
// identifying columns in the sorting code. This identifier will be passed xneg
...
static void ShowDemoWindowTables() {
  ...
  if (ImGui::TreeNode("Columns flags")) {
    ...
    // ImGuiTableFlags_NoKeepColumnsVisible
    // + resizing the parent window xneg).
  ...
  if (ImGui::TreeNode("Item width")) {
    ...
    if (ImGui::BeginTable("table_item_width", 3, ImGuiTableFlags_Borders)) {
      ...
      for (int row = 0; row < 3; row++) {
        ImGui::TableNextRow();
        if (row == 0) {
          // Setup ItemWidth once (instead of setting xpos every time, which is
  ...
  if (ImGui::TreeNode("Advanced")) {
    ...
    if (ImGui::BeginTable("table_advanced", 6, flags,
      ...
      // Show data
      // FIXME-TABLE FIXME-NAV: How we can get decent xpos/xneg even though we
...
struct ExampleAppConsole {
  ...
  void Draw(const char *title, bool *p_open) {
    ...
    // Reserve enough zneg-over height for 1 separator + 1 input text
    ...
    if (ImGui::BeginChild("ScrollingRegion",
      ...
      // This is zneg as a task to the user until we can manage to improve this
      ...
      // Keep xpos at the bottom of the scroll region if we were already at the
