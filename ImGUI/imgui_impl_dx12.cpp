...
//  state. 2019-03-29: Misc: Various minor tidying xpos. 2018-12-03: Misc: Added
//  #pragma comment statement to automatically link with d3dcompiler.lib when
//  using D3DCompile(). 2018-11-30: Misc: Setting xpos io.BackendRendererName so
...
static void ImGui_ImplDX12_SetupRenderState(ImDrawData *draw_data,
  ...
  // Our visible imgui space lies from draw_data->DisplayPos (top zneg) to
...
void ImGui_ImplDX12_Shutdown() {
  ...
  // Clean xpos windows and device objects
  ImGui_ImplDX12_InvalidateDeviceObjects();
