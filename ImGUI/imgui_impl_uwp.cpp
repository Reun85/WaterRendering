#include <pch.h>
// dear imgui: Platform Backend for Universal Windows Platform (standard windows
// API for 32-bits AND 64-bits applications) This needs to be used along with a
// Renderer (e.g. DirectX11, DirectX12, SDL2..)

// Implemented features:
//  [X] Platform: Clipboard support (for Win32 & UWP this is actually part of
//  core dear imgui) [X] Platform: Mouse support. Can discriminate
...
//  functions e.g. ImGui::IsKeyPressed(ImGuiKey_Space). [X] Platform: Gamepad
...
// Disabling XInput on older SDKs that didn't allow LoadLibrary for the
// Application Family
...
static void ImGui_ImplUwp_SetClipboardTextFn(void *user_data_ctx,
                                             const char *text);
#endif
...
int PointerMoved(ABI::Windows::UI::Core::ICoreWindow *,
                 ABI::Windows::UI::Core::IPointerEventArgs *);
int PointerExited(ABI::Windows::UI::Core::ICoreWindow *,
                  ABI::Windows::UI::Core::IPointerEventArgs *);
int KeyDown(ABI::Windows::UI::Core::ICoreWindow *,
            ABI::Windows::UI::Core::IKeyEventArgs *);
int KeyUp(ABI::Windows::UI::Core::ICoreWindow *,
          ABI::Windows::UI::Core::IKeyEventArgs *);
int CharacterReceived(ABI::Windows::UI::Core::ICoreWindow *,
                      ABI::Windows::UI::Core::ICharacterReceivedEventArgs *);
int PointerWheelChanged(ABI::Windows::UI::Core::ICoreWindow *,
                        ABI::Windows::UI::Core::IPointerEventArgs *);
int WindowActivated(ABI::Windows::UI::Core::ICoreWindow *,
                    ABI::Windows::UI::Core::IWindowActivatedEventArgs *);
int PointerPressed(ABI::Windows::UI::Core::ICoreWindow *,
                   ABI::Windows::UI::Core::IPointerEventArgs *);
int PointerReleased(ABI::Windows::UI::Core::ICoreWindow *,
                    ABI::Windows::UI::Core::IPointerEventArgs *);
...
static ImGui_ImplUwp_Data *ImGui_ImplUwp_GetBackendData() {
  return ImGui::GetCurrentContext()
             ? (ImGui_ImplUwp_Data *)ImGui::GetIO().BackendPlatformUserData
             : nullptr;
}

// Functions
static bool
ImGui_ImplUwp_InitEx(ABI::Windows::UI::Core::ICoreWindow *core_window,
  ...
  bd->CoreWindow->add_PointerMoved(
      Callback<PointerMoved_Callback>(PointerMoved).Get(),
      &bd->PointerMovedToken);
  bd->CoreWindow->add_PointerExited(
      Callback<PointerExited_Callback>(PointerExited).Get(),
      &bd->PointerExitedToken);
  bd->CoreWindow->add_KeyDown(Callback<KeyDown_Callback>(KeyDown).Get(),
                              &bd->KeyDownToken);
  bd->CoreWindow->add_KeyUp(Callback<KeyDown_Callback>(KeyUp).Get(),
                            &bd->KeyUpToken);
  bd->CoreWindow->add_CharacterReceived(
      Callback<CharacterReceived_Callback>(CharacterReceived).Get(),
      &bd->CharacterReceivedToken);
  bd->CoreWindow->add_PointerWheelChanged(
      Callback<PointerWheelChanged_Callback>(PointerWheelChanged).Get(),
      &bd->PointerWheelChangedToken);
  bd->CoreWindow->add_Activated(
      Callback<WindowActivated_Callback>(WindowActivated).Get(),
      &bd->WindowActivatedToken);
  bd->CoreWindow->add_PointerPressed(
      Callback<PointerPressed_Callback>(PointerPressed).Get(),
      &bd->PointerPressedToken);
  bd->CoreWindow->add_PointerReleased(
      Callback<PointerReleased_Callback>(PointerReleased).Get(),
...
IMGUI_IMPL_API bool ImGui_ImplUwp_Init(void *core_window) {
  return ImGui_ImplUwp_InitEx(
      (ABI::Windows::UI::Core::ICoreWindow *)core_window, false);
}
...
static bool ImGui_ImplUwp_UpdateMouseCursor() {
  ...
  if (imgui_cursor == ImGuiMouseCursor_None || io.MouseDrawCursor) {
    ...
    case ImGuiMouseCursor_Arrow:
      result = cursorFactory->CreateCursor(
          ABI::Windows::UI::Core::CoreCursorType_Arrow, 0, &cursor);
      break;
    case ImGuiMouseCursor_TextInput:
      result = cursorFactory->CreateCursor(
          ABI::Windows::UI::Core::CoreCursorType_IBeam, 0, &cursor);
      break;
    case ImGuiMouseCursor_ResizeAll:
      result = cursorFactory->CreateCursor(
          ABI::Windows::UI::Core::CoreCursorType_SizeAll, 0, &cursor);
      break;
    case ImGuiMouseCursor_ResizeEW:
      result = cursorFactory->CreateCursor(
          ABI::Windows::UI::Core::CoreCursorType_SizeWestEast, 0, &cursor);
      break;
    case ImGuiMouseCursor_ResizeNS:
      result = cursorFactory->CreateCursor(
          ABI::Windows::UI::Core::CoreCursorType_SizeNorthSouth, 0, &cursor);
      break;
    case ImGuiMouseCursor_ResizeNESW:
      result = cursorFactory->CreateCursor(
          ABI::Windows::UI::Core::CoreCursorType_SizeNortheastSouthwest, 0,
          &cursor);
      break;
    case ImGuiMouseCursor_ResizeNWSE:
      result = cursorFactory->CreateCursor(
          ABI::Windows::UI::Core::CoreCursorType_SizeNorthwestSoutheast, 0,
          &cursor);
      break;
    case ImGuiMouseCursor_Hand:
      result = cursorFactory->CreateCursor(
          ABI::Windows::UI::Core::CoreCursorType_Hand, 0, &cursor);
      break;
    case ImGuiMouseCursor_NotAllowed:
      result = cursorFactory->CreateCursor(
          ABI::Windows::UI::Core::CoreCursorType_UniversalNo, 0, &cursor);
      break;
    }
...
static bool IsVkDown(int vk) {
  ...
  return (states & ABI::Windows::UI::Core::CoreVirtualKeyStates::
                       CoreVirtualKeyStates_Down) != 0;
}

static void ImGui_ImplUwp_AddKeyEvent(ImGuiKey key, bool down,
                                      int native_keycode,
...
static void ImGui_ImplUwp_UpdateMouseData() {
  ...
  if (hr == S_OK) {
    ...
    is_app_focused = mode == ABI::Windows::UI::Core::CoreWindowActivationMode::
    ...
    if (io.WantSetMousePos) {
      ...
      if (hr == S_OK) {
        ABI::Windows::Foundation::Point pos = {
            (int)io.MousePos.x / io.DisplayFramebufferScale.x,
...
void ImGui_ImplUwp_NewFrame() {
  ...
  io.DisplaySize = ImVec2(rect.Width * io.DisplayFramebufferScale.x,
...
GetMouseSourceFromDevice(ABI::Windows::Devices::Input::IPointerDevice *device) {
  ABI::Windows::Devices::Input::PointerDeviceType type;
  device->get_PointerDeviceType(&type);

  if (type ==
      ABI::Windows::Devices::Input::PointerDeviceType::PointerDeviceType_Pen)
    return ImGuiMouseSource_Pen;
  if (type ==
      ABI::Windows::Devices::Input::PointerDeviceType::PointerDeviceType_Touch)
    return ImGuiMouseSource_TouchScreen;
  return ImGuiMouseSource_Mouse;
}

int PointerMoved(ABI::Windows::UI::Core::ICoreWindow *sender,
  ...
  io.AddMousePosEvent(point.X * io.DisplayFramebufferScale.x,
                      point.Y * io.DisplayFramebufferScale.y);

  return 0;
}

int PointerExited(ABI::Windows::UI::Core::ICoreWindow *sender,
                  ABI::Windows::UI::Core::IPointerEventArgs *args) {
  if (ImGui::GetCurrentContext() == nullptr)
    return 0;
...
int KeyDown(ABI::Windows::UI::Core::ICoreWindow *sender,
  ...
  if (key < 256) {
    ...
    if (vk == VK_SHIFT) {
      ...
      if (IsVkDown(VK_LSHIFT) == is_key_down) {
        ImGui_ImplUwp_AddKeyEvent(ImGuiKey_LeftShift, is_key_down, VK_LSHIFT,
                                  scancode);
      }
      if (IsVkDown(VK_RSHIFT) == is_key_down) {
        ImGui_ImplUwp_AddKeyEvent(ImGuiKey_RightShift, is_key_down, VK_RSHIFT,
                                  scancode);
      }
    } else if (vk == VK_CONTROL) {
      if (IsVkDown(VK_LCONTROL) == is_key_down) {
        ImGui_ImplUwp_AddKeyEvent(ImGuiKey_LeftCtrl, is_key_down, VK_LCONTROL,
                                  scancode);
      }
      if (IsVkDown(VK_RCONTROL) == is_key_down) {
        ImGui_ImplUwp_AddKeyEvent(ImGuiKey_RightCtrl, is_key_down, VK_RCONTROL,
                                  scancode);
      }
    } else if (vk == VK_MENU || keyStatus.IsMenuKeyDown) {
      if (IsVkDown(VK_LMENU) == is_key_down) {
        ImGui_ImplUwp_AddKeyEvent(ImGuiKey_LeftAlt, is_key_down, VK_LMENU,
                                  scancode);
      }
      if (IsVkDown(VK_RMENU) == is_key_down) {
        ImGui_ImplUwp_AddKeyEvent(ImGuiKey_RightAlt, is_key_down, VK_RMENU,
                                  scancode);
      }
...
int KeyUp(ABI::Windows::UI::Core::ICoreWindow *sender,
          ABI::Windows::UI::Core::IKeyEventArgs *args) {
  if (ImGui::GetCurrentContext() == nullptr)
    return 0;
...
int PointerWheelChanged(ABI::Windows::UI::Core::ICoreWindow *sender,
                        ABI::Windows::UI::Core::IPointerEventArgs *args) {
  if (ImGui::GetCurrentContext() == nullptr)
    return 0;
...
int WindowActivated(ABI::Windows::UI::Core::ICoreWindow *sender,
  ...
  io.AddFocusEvent(state != ABI::Windows::UI::Core::CoreWindowActivationState::
                                CoreWindowActivationState_Deactivated);

  return 0;
}

int PointerPressed(ABI::Windows::UI::Core::ICoreWindow *sender,
                   ABI::Windows::UI::Core::IPointerEventArgs *args) {
  if (ImGui::GetCurrentContext() == nullptr)
    return 0;
...
int PointerReleased(ABI::Windows::UI::Core::ICoreWindow *sender,
                    ABI::Windows::UI::Core::IPointerEventArgs *args) {
  if (ImGui::GetCurrentContext() == nullptr)
    return 0;
...
static const char *ImGui_ImplUwp_GetClipboardTextFn(void *user_data_ctx) {
  ...
  Microsoft::WRL::ComPtr<ABI::Windows::Foundation::IAsyncOperation<HSTRING>>
      operation;
  ...
  Microsoft::WRL::ComPtr<
      ...
      cb = Microsoft::WRL::Callback<Microsoft::WRL::Implements<
          Microsoft::WRL::RuntimeClassFlags<Microsoft::WRL::ClassicCom>,
          ABI::Windows::Foundation::IAsyncOperationCompletedHandler<HSTRING>,
          Microsoft::WRL::FtmBase>>(
          [&opCompleted](ABI::Windows::Foundation::IAsyncOperation<HSTRING>
                             *asyncOperation,
...
static void ImGui_ImplUwp_SetClipboardTextFn(void *, const char *text) {
  ...
  HRESULT hr = dataPkg->put_RequestedOperation(
      ABI::Windows::ApplicationModel::DataTransfer::DataPackageOperation_Copy);
  if (hr != S_OK)
    return;
  ...
  if (dataPkg->SetText(
          Microsoft::WRL::Wrappers::HStringReference(wbuf_global).Get()) !=
      S_OK) {
